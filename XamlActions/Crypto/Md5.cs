...
namespace XamlActions.Crypto {
    ...
    // Modified by André Carlucci 2013
    ...
    public static class Md5 {
        ...
        public static byte[] GetHash(string input, Encoding encoding = null) {
        ...
        public static string GetHashString(string input, Encoding encoding = null) {
            if (encoding == null) encoding = new UTF8Encoding();
            byte[] target = encoding.GetBytes(input);
